...
IMG_DIR = "/home/user/Dataset/Jeju/1_kau_1010/annotated/"
# OUTPUT_DIR = "/home/user/Dataset/Jeju/2_kau_1025/1024/"
OUTPUT_DIR = "/home/user/Dataset/Jeju/1_kau_1010/annotated/1024/"

#5456, 3632 (1024x5 + 336, 1024x3 + 560 -> 15 + 3 + 5 + 1 = 24)
...
for filename in file_names:
    ...
    # if orientation is not None:
        orientation = IP.getExif(os.path.join(IMG_DIR + filename))
        ...
        for hei in range((img.shape[0] // crop_height) + 1):  # 10/13 sujung
            for wid in range((img.shape[1] // crop_width) + 1):
                ...
                cv2.imwrite(OUTPUT_DIR + "{}_1024_{}.jpg".format(os.path.splitext(filename)[0], idx), img_crop)
